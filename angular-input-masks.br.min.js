...
(function() {
	...
	.directive('uiMoneyMask', ['$locale', '$parse','AppService',, function ($locale, $parse, AppService) {
		return {
			restrict: 'A',
			require: '?ngModel',
			link: function (scope, element, attrs, ctrl) {
				...
				ctrl.$formatters.push(function(value) {
					if(!value) {
						...
						//console.log('value',decimals);parseFloat(tax_value).toFixed(2);
	...
	.directive('uiBrPhoneNumber',function() {
		 ...
		 * updated guilherme
		 */
		var phoneMask8D = new StringMask('+00 (00) 0000-0000'),
			phoneMask9D = new StringMask('+00 (00) 00000-0000');

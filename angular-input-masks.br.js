...
.directive('uiMoneyMask',
	['$locale', '$parse', 'PreFormatters', 'NumberValidators', 'AppService',
	function ($locale, $parse, PreFormatters, NumberValidators, AppService) {
		return {
			restrict: 'A',
			require: 'ngModel',
			link: function (scope, element, attrs, ctrl) {
				var decimalDelimiter = $locale.NUMBER_FORMATS.DECIMAL_SEP,
					...
					currencySym = AppService.getCompanyCurrency(),
